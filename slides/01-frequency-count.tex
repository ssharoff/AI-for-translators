...
\frame[<+->]{ \frametitle{Data science for translators}
\begin{itemize}
  \item ChatGPT and other AI models: Large Language Models
  \item [$\to$] Large corpora: 90,000 years of reading for ChatGPT
  \item Statistics for understanding how LLMs and MT engines work
  \item Future careers for engaging with model developers
\end{itemize}
}
\frame[<+->]{
